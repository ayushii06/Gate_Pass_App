        ...
        <div className="flex-1 flex flex-col items-center justify-center px-4 my-12 sm:px-6 lg:px-8">
          <div className="w-full max-w-md">
            ...
            <form onSubmit={handleSubmit} className='space-y-6'>
              ...
              <div className="space-y-2">
                <Label htmlFor="rollNo" className="block text-white font-medium">Roll Number</Label>
                <Input id="rollNo" placeholder="john@rgipt.ac.in" value={credentials.rollNo} onChange={(e) => {
                  handleOnChange(e)}
                } name='rollNo' required className="text-white bg-transparent" />
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div className="space-y-2">
                  <Label htmlFor="year" className="block text-white font-medium">Year</Label>
                  <Select
                    id="year" className="text-white bg-transparent"
                    value={credentials.year}
                    onValueChange={(value) =>
                      setCredentials({ ...credentials, year: value })
                    }
                  >
                    <SelectTrigger>
                ...
                <div className="space-y-2">
                  <Label htmlFor="branch" className="block text-white font-medium">Branch</Label>
                  <Select
                    id="branch" className="text-white bg-transparent"
              ...
              <div className="flex flex-col space-y-4">
                ...
                <div className="text-center text-sm text-white">
                  Are you Faculty / Hostel Office ?{" "}
                  <Link to="/signup-faculty" className="text-cyan-400 hover:underline">
                    Register Here
                  </Link>
